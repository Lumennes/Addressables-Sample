...
namespace YG
{
    public class YandexGame : MonoBehaviour
    {
        ...
        static bool _debug;
        static readonly bool _cloudSaves;
        static bool _scopes;
        public static JsonSaves savesData = new();
        ...
        public static void SaveLocal()
        {
            ...
            FileStream fs = new(Application.persistentDataPath + "/SavesYG/saveyg.svyg", FileMode.Create);
        ...
        public static void LoadLocal()
        {
            ...
            {
                FileStream fs = new(Application.persistentDataPath + "/SavesYG/saveyg.svyg", FileMode.Open);
                BinaryFormatter formatter = new();
                try // загрузка
                {
...
#endif
#if UNITY_EDITOR
                //Invoke(nameof(CloseFullscreen), 1);
                Message("Fullscren Ad");
                StartCoroutine(CloseFullscreenCoro(5));
                OpenFullscreen();                
#endif
            //}
        ...
        IEnumerator CloseFullscreenCoro(float time)
        {
